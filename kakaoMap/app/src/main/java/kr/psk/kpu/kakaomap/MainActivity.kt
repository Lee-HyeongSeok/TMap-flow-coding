...
private val LOG_TAG = "MainActivity"
    ...
    lateinit var mapPointGeo: GeoCoordinate
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //var list:ArrayList<Kicks>?=null

        myRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                for (postSnapshot in dataSnapshot.children) {
                    var kicks:Kicks?=null
                   var latitude=postSnapshot.child("latitude").getValue<Double>()
                    var longitude=postSnapshot.child("longitude").getValue<Double>()
                    var kicksnum=postSnapshot.child("kicksnum").getValue<Int>()
                    Log.d("킥고잉","latitude : $latitude, longitude=$longitude, kicksnum : $kicksnum")

                    val mappoint:MapPoint= mapPointWithGeoCoord(latitude!!,longitude!!)
                    marker= MapPOIItem()
                    marker.mapPoint=mappoint
                    marker.itemName=kicksnum.toString()
